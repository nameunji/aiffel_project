...
# 1. 데이터 준비
train_data = pd.read_table('/data/e4_sentiment_classification/ratings_train.txt')
test_data = pd.read_table('/data/e4_sentiment_classification/ratings_test.txt')
...
word2vec_file_path = os.getenv('HOME')+'/aiffel/e4_sentiment_classification/koword2vec.txt'
...
word2vec_path = os.getenv('HOME')+'/aiffel/e4_sentiment_classification/ko/ko.bin'
