...
def change_file_size(path):
    image_dir_path = os.getenv("HOME") + "/aiffel/data/e1_rock_scissor_paper_classifier/" + path
...
image_dir_path = os.getenv("HOME") + "/aiffel/data/e1_rock_scissor_paper_classifier/train"
...
image_dir_path = os.getenv("HOME") + "/aiffel/data/e1_rock_scissor_paper_classifier/test"
